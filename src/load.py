...
if __name__ == "__main__":
    ...
    load_dataframe_to_snowflake(players_df, 'raw_players', cursor)
    load_dataframe_to_snowflake(matches_df, 'raw_matches', cursor)
    load_dataframe_to_snowflake(player_stats_df, 'raw_player_stats', cursor)
